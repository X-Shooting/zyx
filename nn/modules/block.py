...
class C3k2_MSCB1(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        # ½âÎö c3kÔÚÖ÷¸ÉºÍÍøÂç×îºóÒ»¸öC3k2µÄÊ±ºòÉèÖÃTrue×ßµÄÊÇC3k, ·ñÔòÎÒÃÇ×ßµÄÊÇMSBlock
...
class C3k2_DSConv(C2f):
    ...
    # ÔÚÌØÕ÷ÌáÈ¡Ê±ÓÃDSConv,ÔÚ¸¨ÖúÌØÕ÷ÈÚºÏÊ±»»»ØÔ­ÏÈµÄBottleneck
...
class LocalWindowAttention(torch.nn.Module):
    ...
    def __init__(self, dim, num_heads=4,
                 ...
                 kernels=[5, 5, 5, 5], ):
        super().__init__()
        key_dim = dim // 16  # ±ØÐë·ÅËõ16±¶·ñÔò»á±¨´í
        self.dim = dim
        self.num_heads = num_heads
...
class C3k2_GhostModule(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        )  # c3k = TrueÓÃC3kÌáÈ¡ÌØÕ÷, False Ê±ÓÃGhostBottleneckÈÚºÏÌØÕ÷
